...
export const Calculator = stroke(
  <>
...
export const HelpCircle = stroke(
  <>
...
export const CheckCircle = stroke(
  <>
...
export const ChevronLeft = stroke(<polyline points="15 18 9 12 15 6" />);

export const ChevronRight = stroke(<polyline points="9 18 15 12 9 6" />);

export const ImageOff = stroke(
  <>
